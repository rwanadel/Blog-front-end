  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 relative">
      <div className="col-span-1 md:col-span-2 text-center h-auto  px-4 py-6">
        <Navbar />
        <div className="mt-44">
        <h1  className="font-mono font-bold text-4xl md:text-7xl m-5">Welcome to R/Blog</h1>
        <p className="w-full max-w-2xl m-auto text-start text-gray-500 text-base md:text-lg">
          Discover a world of insightful articles, engaging stories, and expert perspectives.
          Whether you’re passionate about technology, eager to explore new ideas,
          or just looking for thought-provoking content,
          R/Blog offers a rich blend of topics to spark your curiosity and enrich your knowledge.
        </p>
        </div>
        
      </div>
      <div style={{backgroundColor:'#be7c68 ',height:'600px'}} className="col-span-1 relative  md:h-96">
        <img
      ...
      <Link style={{backgroundColor: '#be7c68'}}  to="/NewPost" className="btn btn-active text-white w-60 ms-44" >Add New Post</Link>
    </div>
  );
}
